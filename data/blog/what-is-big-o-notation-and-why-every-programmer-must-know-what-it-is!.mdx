---
title: "What is Big O Notation And Why Every Programmer Must Know What It Is! 👉 Part 1 - The Time Complexity"
...
tags: ["Asymptotic Analysis","Algorithms", "Big O", 'Time Complexity']
---
...
```py:print_all_possible_ordered_pairs.py
...
```py:drop_less_significant_terms.py
...
In the next post let's dive deep into analysis of Time Complexity of a given algorithm and understand some of the pitfalls to avoid.
