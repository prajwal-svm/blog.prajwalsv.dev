---
title: "How to notify sate changes between 2 components that use the same custom hook with local-state?"
publishedAt: "2020-04-08"
summary: "States defined in custom hooks are local to its use in every component. Meaning updating state in one component doesn't reflect in another."
