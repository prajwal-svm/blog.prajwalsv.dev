---
title: 'What is Big O Notation And Why Every Programmer Must Know What It Is! 👉 Part 2 - Time Complexity Analysis'
publishedAt: '2022-04-28'
summary: 'Learn how to analyse the Time Complexity of a given algorithm...'
tags: ['Asymptotic Analysis', 'Algorithms', 'Time Complexity']
---
...
```py
n * 1/2 * 1/2 * 1/2 * 1/2 * .... = 1  # keep on reducing the bound by half until we go down to 1
```
...
<details>
  ...
  <details>
    ...
    <details>
      ...
      <br />
      <div style={{borderLeft: '5px solid #90cdf4', padding: '10px', background: '#1a365d'}}>
